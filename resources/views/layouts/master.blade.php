...
rel="stylesheet" type="text/css"/><!-- Modernizr JS -->
<script
...
href="/categories">Tampil Kategori</a>
<a class="dropdown-item"
href="/categories/categories">Tambah Kategori</a>
</div>
</li>
<li class="nav-item dropdown">
<a class="nav-link dropdown-toggle"
href="#" id="dropdownMenuButton2" data-toggle="dropdown"
aria-haspopup="true"
aria-expanded="false">Berita <span
class="sr-only">(current)</span></a>
<div class="dropdown-menu"
aria-labelledby="dropdownMenuLink_1">
<a class="dropdown-item"
href="/news">Tampil Berita</a>
<a class="dropdown-item"
href="/news/create">Tambah Berita</a>
</div>
</li>
@endauth
@guest
...
href="/login"> <span class="text-white">Login</span> <span
class="sr-only">(current)</span></a>
</li>
<li class="nav-item">
<a class="nav-link bg-primary"
href="/register"> <span class="text-white">Register</span> <span
class="sr-only">(current)</span></a>
</li>
@endguest
@auth
...
integrity="sha384-A7FZj7v+d/sdmMqp/nOQwliLvUsJfDHW+k9Omg/a/EheAdg
tzNs3hpfag6Ed950n" crossorigin="anonymous"></script>-->
<script
...
<!-- Waypoints -->
<script
src="{{asset('template/js/jquery.waypoints.min.js')}}"></script><!-- Main -->
