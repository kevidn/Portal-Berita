...
@section('content')
    <div class="container padding">
        ...
        <img src="{{ asset('/uploads/'.$news->thumbnail) }}" width="100%" height="500px" alt="{{ $news->title }}">
        <div class="my-3">
            ...
            @forelse ($news->comments as $item)
                <div class="media">
                    <img src="{{ asset('/uploads/profile/'.$item->user->profile->photo_profile) }}" class="mr-3 rounded-circle" width="75px" height="75px" alt="{{ $item->user->name }}">
